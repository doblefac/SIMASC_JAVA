...
public class EnvioCorreoServiceSoap12Proxy{
    private static final Logger logger = LogManager.getLogger(EnvioCorreoServiceSoap12Proxy.class.getName());
    ...
    public class Descriptor {
        ...
        public void init() {
            ...
            catch (NamingException e)
            {
                if ("true".equalsIgnoreCase(System.getProperty("DEBUG_PROXY"))) {
                    logger.error("JNDI lookup failure: javax.naming.NamingException: ", e);                    
                }
            }
        ...
        private void initCommon() {
            _proxy = _service.getEnvioCorreoServiceSoap12();
        }
        ...
        public Dispatch<Source> getDispatch() {
            if (_dispatch == null ) {
                QName portQName = new QName("", "EnvioCorreoServiceSoap12");
    ...
    public EnvioCorreoServiceSoap12Proxy() {
        _descriptor = new Descriptor();
        _descriptor.setMTOMEnabled(false);
    }

    public EnvioCorreoServiceSoap12Proxy(URL wsdlLocation, QName serviceName) {
