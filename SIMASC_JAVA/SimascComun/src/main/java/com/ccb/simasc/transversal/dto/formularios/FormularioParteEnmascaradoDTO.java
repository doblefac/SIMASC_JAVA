...
/**
 * ADM-C-021 ARB-F-050 DAO que contiene la información del formulario para la
 * creacion de parte representante sea abogado demandante o abogado demandado.
 * Este formulario esta construido para los servicios REST
 * 
 * @author dpachon
 */
@XmlRootElement
public class FormularioParteEnmascaradoDTO implements Serializable {
	...
	private String numeroTelefonoUnoEnmascarado;
	private String numeroTelefonoDosEnmascarado;
	private String numeroCelularEnmascarado;
	private String emailUnoEnmascarado;
	private String emailUnoAnteriorEnmascarado;
	private String emailDosEnmascarado;
	private String emailDosAnteriorEnmascarado;
	private String emailTresEnmascarado;
	private String emailTresAnteriorEnmascarado;
	private Dominio tipoSexo;
	private String fechaNacimientoEnmascarado;
	private DominioEnmascaradoDTO estrato;
	private Profesion profesion;
	private DominioEnmascaradoDTO escolaridad;
	private DominioEnmascaradoDTO institucionEducativa;
	...
	private List<CorreoElectronicoEnmascaradoDTO> correosElectronicos;
	...
	/**
	 * @param ciudadIdentificacion
	 *            the ciudadIdentificacion to set
	 */
	...
	/**
	 * @param primerApellidoORazonSocial
	 *            the primerApellidoORazonSocial to set
	 */
	 ...
	 */
	public String getNumeroTelefonoUnoEnmascarado() {
		return numeroTelefonoUnoEnmascarado;
	}

	/**
	 * @param numeroTelefonoUno
	 *            the numeroTelefonoUno to set
	 */
	public void setNumeroTelefonoUnoEnmascarado(String numeroTelefonoUnoEnmascarado) {
		this.numeroTelefonoUnoEnmascarado = numeroTelefonoUnoEnmascarado;
	}

	/**
	 * @return the numeroTelefonoDos
	 */
	public String getNumeroTelefonoDosEnmascarado() {
		return numeroTelefonoDosEnmascarado;
	}

	/**
	 * @param numeroTelefonoDos
	 *            the numeroTelefonoDos to set
	 */
	public void setNumeroTelefonoDosEnmascarado(String numeroTelefonoDosEnmascarado) {
		this.numeroTelefonoDosEnmascarado = numeroTelefonoDosEnmascarado;
	}

	/**
	 * @return the numeroCelular
	 */
	public String getNumeroCelularEnmascarado() {
		return numeroCelularEnmascarado;
	}
	 ...
	 */
	public void setNumeroCelularEnmascarado(String numeroCelularEnmascarado) {
		this.numeroCelularEnmascarado = numeroCelularEnmascarado;
	}

	/**
	 * @return the emailUno
	 */
	public String getEmailUnoEnmascarado() {
		return emailUnoEnmascarado;
	}
	 ...
	 *            the emailUno to set
	 */
	public void setEmailUnoEnmascarado(String emailUnoEnmascarado) {
		this.emailUnoEnmascarado = emailUnoEnmascarado;
	}

	/**
	 * @return the emailDos
	 */
	public String getEmailDosEnmascarado() {
		return emailDosEnmascarado;
	}
	 ...
	 *            the emailDos to set
	 */
	public void setEmailDosEnmascarado(String emailDosEnmascarado) {
		this.emailDosEnmascarado = emailDosEnmascarado;
	}

	/**
	 * @return the emailTres
	 */
	public String getEmailTresEnmascarado() {
		return emailTresEnmascarado;
	}

	/**
	 * @param emailTres
	 *            the emailTres to set
	 */
	public void setEmailTresEnmascarado(String emailTresEnmascarado) {
		this.emailTresEnmascarado = emailTresEnmascarado;
	}
	 ...
	 */
	public String getFechaNacimientoEnmascarado() {
		return fechaNacimientoEnmascarado;
	}
	 ...
	 */
	public void setFechaNacimientoEnmascarado(String fechaNacimientoEnmascarado) {
		this.fechaNacimientoEnmascarado = fechaNacimientoEnmascarado;
	}

	/**
	 * @return the estrato
	 */
	public DominioEnmascaradoDTO getEstrato() {
		return estrato;
	}
	 ...
	 *            the estrato to set
	 */
	public void setEstrato(DominioEnmascaradoDTO estrato) {
	 ...
	 */
	public DominioEnmascaradoDTO getEscolaridad() {
		return escolaridad;
	}
	 ...
	 */
	public void setEscolaridad(DominioEnmascaradoDTO escolaridad) {
	 ...
	 */
	public DominioEnmascaradoDTO getInstitucionEducativa() {
		return institucionEducativa;
	}

	/**
	 * @param institucionEducativa
	 *            the institucionEducativa to set
	 */
	public void setInstitucionEducativa(DominioEnmascaradoDTO institucionEducativa) {
	 ...
	 *            the numeroTarjetaProfesional to set
	 */
	...
	/**
	 * @param entidadTarjetaProfesional
	 *            the entidadTarjetaProfesional to set
	 */
	...
	/**
	 * @param tipoEntidadPublica
	 *            the tipoEntidadPublica to set
	 */
	...
	public List<CorreoElectronicoEnmascaradoDTO> getCorreosElectronicos() {
		return correosElectronicos;
	}

	public void setCorreosElectronicos(List<CorreoElectronicoEnmascaradoDTO> correosElectronicos) {
	...
	public String getEmailUnoAnteriorEnmascarado() {
		return emailUnoAnteriorEnmascarado;
	}

	public void setEmailUnoAnteriorEnmascarado(String emailUnoAnteriorEnmascarado) {
		this.emailUnoAnteriorEnmascarado = emailUnoAnteriorEnmascarado;
	}

	public String getEmailDosAnteriorEnmascarado() {
		return emailDosAnteriorEnmascarado;
	}

	public void setEmailDosAnteriorEnmascarado(String emailDosAnteriorEnmascarado) {
		this.emailDosAnteriorEnmascarado = emailDosAnteriorEnmascarado;
	}

	public String getEmailTresAnteriorEnmascarado() {
		return emailTresAnteriorEnmascarado;
	}

	public void setEmailTresAnteriorEnmascarado(String emailTresAnteriorEnmascarado) {
		this.emailTresAnteriorEnmascarado = emailTresAnteriorEnmascarado;
	}
