 ...
 */
@XmlRootElement
public class DominioEnmascaradoDTO extends IDTO<Dominio> implements Serializable{	
	...
	private DominioPKDTO dominioPK;
    ...
    public DominioEnmascaradoDTO(){
    	dominioPK = new DominioPKDTO();
	...
	public DominioPKDTO getDominioPK() {
		return dominioPK;
	}

	public void setDominioPK(DominioPKDTO dominioPKDTO) {
		this.dominioPK = dominioPKDTO;
	}
    ...
    public boolean equals(Object obj) {
        ...
        final DominioEnmascaradoDTO other = (DominioEnmascaradoDTO) obj;
    ...
    @Override
	public DominioEnmascaradoDTO transformarSinDependencias(Dominio obj) {
		DominioEnmascaradoDTO dominioDTO = new DominioEnmascaradoDTO();
		
		DominioPKDTO dominioPKDTO = new DominioPKDTO(obj.getDominioPK().getDominio(), obj.getDominioPK().getCodigo());
		
		dominioDTO.setDominioPK(dominioPKDTO);
	...
	@Override
	public DominioEnmascaradoDTO transformarConDependencias(Dominio obj) {
		DominioEnmascaradoDTO dominioDTO = transformarSinDependencias(obj);
	...
	public Collection transformarColeccionConDependencias(Collection<Dominio> coleccion) {
		List<DominioEnmascaradoDTO> dominioDTOList = new ArrayList<>();
	...
	@Override
	public List<DominioEnmascaradoDTO> transformarColeccionSinDependencias(Collection<Dominio> coleccion) {
		List<DominioEnmascaradoDTO> dominioDTOList = new ArrayList<>();
		for(Dominio c : coleccion)
	...
	public static List<String> obtenerCodigosDominiosDTO(List<DominioEnmascaradoDTO> dominios){
		List<String> codigos = new ArrayList<>();
		if(dominios!=null && !dominios.isEmpty()){
			for(DominioEnmascaradoDTO dominio : dominios){
				codigos.add(dominio.getDominioPK().getCodigo());				
			}
		}		
