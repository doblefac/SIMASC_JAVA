...
import static com.ccb.simasc.integracion.utilidades.UtilConstantes.INT_PRIMITIVE;
import static com.ccb.simasc.integracion.utilidades.UtilConstantes.LONG_PRIMITIVE;
...
public class UtilReflection {        
    ...
    public static Method consultarMetodoGetAtributo(Object objId, String nombreAtributo){
        ...
        try {
            ...
            logger.error(ex);
            throw new ReflectionException(MensajesSimasc.getInstancia().getMensajePorKey(
					MensajesEnum.INFO045.toString()) + nombreAtributo + MensajesSimasc.getInstancia().getMensajePorKey(
							MensajesEnum.INFO046.toString()));
        } 
    ...
    public static void setParameter(Query q, Parameter p, String value) {
        ...
        if (value == null) {
            ...
            throw new IllegalArgumentException(MensajesSimasc.getInstancia().getMensajePorKey(
					MensajesEnum.INFO049.toString())+c.getName());
        }
    }
}
